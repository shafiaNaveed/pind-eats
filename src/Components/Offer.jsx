...
function Offer() {
  return (
     <div className='w-[94vw] h-[20vw] bg-[#FE912F] flex flex-row gap-[3vw] rounded-[16px] relative top-[26vw] left-[3vw]'>
             <img className='w-[17vw] h-[17vw] relative top-[3vw]' src={pizza} alt="" />
             <div className='w-[48vw] h-[17vw] relative flex flex-col left-[2vw] gap-[1vw] top-[2vw]'>
